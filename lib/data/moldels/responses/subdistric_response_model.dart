...
class SubDistricResponseModel {
    final Rajaongkir rajaongkir;

    SubDistricResponseModel({
        required this.rajaongkir,
    });

    factory SubDistricResponseModel.fromJson(String str) => SubDistricResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory SubDistricResponseModel.fromMap(Map<String, dynamic> json) => SubDistricResponseModel(
