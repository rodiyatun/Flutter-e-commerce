...
class AddAddressReponseModel {
    ...
    factory AddAddressReponseModel.fromJson(String str) => AddAddressReponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory AddAddressReponseModel.fromMap(Map<String, dynamic> json) => AddAddressReponseModel(
