    ...
    return _then(_$AddAddressImpl(
      ...
      cityId: null == cityId
          ...
          : cityId // ignore: cast_nullable_to_non_nullable
              as String,
      subdistricId: null == subdistricId
          ? _value.subdistricId
          : subdistricId // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$AddAddressImpl implements _AddAddress {
  ...
  @override
  String toString() {
    return 'AddAddressEvent.addAddress(name: $name, address: $address, phone: $phone, provinceId: $provinceId, cityId: $cityId, subdistricId: $subdistricId, codePos: $codePos, isDefault: $isDefault, userId: $userId, provinceName: $provinceName, cityName: $cityName, subdistrictName: $subdistrictName)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.subdistricId, subdistricId) ||
                other.subdistricId == subdistricId) &&
  ...
  TResult when<TResult extends Object?>({
    ...
    return addAddress(name, address, phone, provinceId, cityId, subdistricId,
        codePos, isDefault, userId, provinceName, cityName, subdistrictName);
  }
...
abstract class _AddAddress implements AddAddressEvent {
  const factory _AddAddress(
      ...
      required final String subdistricId,
      required final String codePos,
      required final bool isDefault,
      required final String userId,
      required final String provinceName,
      required final String cityName,
      required final String subdistrictName}) = _$AddAddressImpl;
...
mixin _$AddAddressState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AddAddressReponseModel response) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AddAddressReponseModel response)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({AddAddressReponseModel response});
}
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  final AddAddressReponseModel response;
...
abstract class _Loaded implements AddAddressState {
  const factory _Loaded(final AddAddressReponseModel response) = _$LoadedImpl;

  AddAddressReponseModel get response;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
